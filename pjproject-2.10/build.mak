export PJDIR := /Users/ncamargo/projects/Telephone/pjproject-2.10
...
export CC_NAME := gcc
export TARGET_ARCH := 
export TARGET_NAME := arm-apple-darwin
export CROSS_COMPILE := arm-apple-darwin-
export LINUX_POLL := select 
export SHLIB_SUFFIX := dylib

export prefix := /Users/ncamargo/projects/Telephone/ThirdParty/PJSIP
...
export APP_CXXFLAGS := -arch arm64 -Os -DNDEBUG -mmacosx-version-min=13.5 $(APP_CFLAGS)
